...
class WalmartTakeHomeAssingnmentTests: XCTestCase {
    ...
    func testFetchErrorsError() {
        ...
        do {
            ...
            self.networkManager.handle(error: error)
    ...
    func testfetchData (){
        ...
        do {
            ...
            //There could be a lot more detailed checking here.
    ...
    func testModelDecode() {
        ...
        do {
            let productFeed = try JSONDecoder().decode(ProductsSummaryStruct.self, from: self.testData)
